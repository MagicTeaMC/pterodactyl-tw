...
@section('content-header')
    <h1>Nodes<small>面板可用的節點</small></h1>
    <ol class="breadcrumb">
                    ...
                    <form action="{{ route('admin.nodes') }}" method="GET">
                        <div class="input-group input-group-sm">
                            ...
                            <div class="input-group-btn">
                                ...
                                <a href="{{ route('admin.nodes.new') }}"><button type="button" class="btn btn-sm btn-primary" style="border-radius: 0 3px 3px 0;margin-left:-1px;">建立新的</button></a>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    (function pingNodes() {
        $('td[data-action="ping"]').each(function(i, element) {
            $.ajax({
                ...
                var errorText = '連線節點時發生錯誤 請打開開發者工具->控制台 來查看詳細錯誤訊息';
                try {
