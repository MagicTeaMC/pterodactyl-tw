                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                @if(is_null($server->external_id))
                                    <td><span class="label label-default">未設置</span></td>
                                @else
                                    <td><code>{{ $server->external_id }}</code></td>
                                @endif
                            </tr>
                            <tr>
                                <td>UUID / Docker 鏡像 ID</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                        <span class="label label-default">未設置</span>
                                    @endif
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    /
                                    @if($server->swap === 0)
                                        <code data-toggle="tooltip" data-placement="top" title="交換空間">未設置</code>
                    ...
                    @if(!$server->isInstalled())
                        <div class="col-sm-12">
                            <div class="small-box {{ (! $server->isInstalled()) ? 'bg-blue' : 'bg-maroon' }}">
                                <div class="inner">
                                    <h3 class="no-margin">{{ (! $server->isInstalled()) ? '正在安裝' : '安裝失敗' }}</h3>
                                </div>
                            </div>
                        </div>
                    @endif
                    <div class="col-sm-12">
                        <div class="small-box bg-gray">
                            ...
                            <a href="{{ route('admin.users.view', $server->user->id) }}" class="small-box-footer">
                                詳情 <i class="fa fa-arrow-circle-right"></i>
                            </a>
                        </div>
                    </div>
                    <div class="col-sm-12">
